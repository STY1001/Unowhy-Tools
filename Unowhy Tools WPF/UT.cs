/*
            ...
            :>>iii>>>>>>lI;,""""""""""",IIIIIIIIII,",IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIli>>>>>>ilIIIIIIIIIIIIIIIIII^
             "!>>>>>>>>>><<<ilIIllllllllIIIIIIIIIIIlIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIli>>>>>>ilIIIIIIIIIIIIII;`
              ...
              ''''``````^`^^^^^"""""",,,,,,,I,,::::,,:,,:,",,"^,"^^^^"'>$$~ `   '(,\8$L >{                      
              ''''``````````^`.'`'''`````^,^^^^^^^,^^^````'`'''''^^^^^'i@@< `   \.c$$$$1 t.                     
              '''````````^,`I<<~~~~++++__--____-__+~_-+_+_++~~~<>"^:^^.i@$< ` .|^Y$$$%Wc -+                     
              '''``````^`^; j$%MWWWWWWWWWWWWWWWWWWB$8MWWWWWWWM&$Bi`,^^.i@$>.^ {+ n|?i:^. `]+~!'                 
              ''``````^^^^^ j$aIIIIlIll!l!ll!ili<:m$u"<iIIIII,}$Bi`^^"'i@$<.^ I             ^I~-~`        '^`   
              '``````""`^^" j$k``^^^^""",:::;;:;l^Z$x`l::,,,,`]$B!'^^^'i@$<.`    ..             :_?Il<illllIi_? 
              ````^``^^^^^" r$o!i>ii>><>>i;IIIIII"Z$n^!l;;::I^[$B<,;,:^<@$<."                     `iI;~(uCw0 ,| 
              ````````^^^",.j@%888888888%O,lIIlIllZ$u^lI;;:;I^[$$&WWMWW&$$<.;' I!`                   \@@$$$/'f. 
              `````^^^^^^^"^I<+++____-~p$m,lllll>!Z$v,lII;;li:I?-]+X$o??-_,`^  ^<??"                 ^h$$%{'|,  
              '''''``````^^^^`"`^^^I,,`O$Z:lllll!,Z$n,!IIIlII;,^^^ /$d^.'."^`     `'                  i*L!!)'   
              ,,,,,:::::::;IIIIlll!<i>Im$m,ll!ll!:Z$n:!IlIl;;::;;;`j$d^,""^^^  .`             ^         :?_     
              &&&&&&&&&&&&&&&&&&&&&&88&B$w:!l!l>i:Z$n,iliIIl;;I;:, /$b.;^^^^^. <|           ^1`  :    '1_       
              ++++++______---?-?]??]]][]?_l!l!l!!I_[~i<lll;,:,^,:!<({?rOl`"^^  .L{l;+[      ,xlI__  . [>        
                   ......`````^^",",",,,:;lIillillI;;;i::l>-?[jrnn/c0',XC ,^^   :,;l~uI. .,  `i!"    `1         
              ^^^^^^^^^"",,,:;::II;IIIllIll<?Illlll!]1;}Ynnr{|#i:,^.d( ,h~  .        `~<<--      .~\tC/?.       
              ``^^``^^"^^""",;,::::;;;lIllli>!Il!lI<\wx<M~,I:`0r ,^ ~k: /b[\rl                   :juC!l]'       
              ``````^^"^^^""";;,,::::;;;IIIIilI><!lI^<o:vL';".ioii?1(p1.:([~I.                  jnn_{vf         
              ``````^"^^^^:"",,,,,:::;:;I!IIlII~>;IIl^zJ`o(-)/f01{\[+:"^^  .'   .^:li<>!I:,,:l<_-_nx ._^        
              ``^``^^^^^^"",,",:,iI:I;:;;llIIII!lIIIIIIo]}c\{?>""`.'`^^^","^^ i~~<!;'  "I!iilI'    ;.           
              .''''''''''``````^^"`^"^^^"","","",",",,.)x ...`'^``^``````''`' .                                 
                                                         ....    .                                              
              '^,,,",:,,,::,,:;::I:::;;:;I:,:;;,;;I,IlI:I;I:;::,;II;;:^";:,^"''`'                               
              ,:,,""^":!,,IlII:;;;;;;;;li!I:;:;::,::Ii<l,,:,:",,:,,,I;;:lllII"^^""`.                            
              `````^"",,,:!>>ll!ii><<~~~~+___-_-____~+--+<<>>ilii!lll!!l:"^`````^,:,^.                          
              .......'''''''''```````^^^^^^^^^^^^^^^^^^`^^^````````'''........... .```.  ',                     
                                                                                         .^                     
...
namespace Unowhy_Tools
{
    public partial class UT
    {
        ...
        public static string verbuild = "1122081223";
