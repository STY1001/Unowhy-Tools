...
namespace Unowhy_Tools_WPF.Views.Windows
{
    ...
    public partial class EditorWindow : Wpf.Ui.Controls.UiWindow
    {
...
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Clicked: " + tag, "Unowhy_Tools_WPF");
#endif
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor got focus", "Unowhy_Tools_WPF.Editor");
#endif
            UpdateLine();
        }
        ...
        private void RootTextBox_OnPreviewMouseDown(object sender, MouseButtonEventArgs e)
        {
            if (e.ClickCount > 2)
                return;
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor mouse down", "Unowhy_Tools_WPF.Editor");
#endif
            UpdateLine();
        }
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor key up", "Unowhy_Tools_WPF.Editor");
#endif
            UpdateLine();
        }
